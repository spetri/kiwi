...
json.extract! event, :details, :name, :created_at, :updated_at, :local_time, :local_date, :tv_time, :is_all_day, :time_format, :description, :width, :height, :crop_x, :crop_y, :user, :country, :location_type, :subkast, :comment_count
